$(function(){
    $(".mvBox").hover(function(){
        $(".item1_mv").animate({left: -65+"vw"},3000);
        $(".item2_mv").animate({left: -61+"vw"},3000);
        $(".item3_mv").animate({left: -55+"vw"},3000);
    },function(){
        $(".item1_mv").animate({left: 5+"vw"},3000);
        $(".item2_mv").animate({left: -5+"vw"},3000);
        $(".item3_mv").animate({left: -7+"vw"},3000);
    })
